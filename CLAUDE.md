...
Skills are `.md` files in `skill_directories` (default: `.agents`, `.claude`, `.cursor`) injected as system instructions. `aux_files` are specific files included as context.
